...
void setup() {
  ...
  PImage friends = loadImage("boris.jpg");  // 2. Change this to match the name of your photo. 
  ...
  mustache = loadImage("mustashe 2.png"); // 5. Change this to match your file name.
}

void draw() {
  // 8. Only draw the mustache when the mouse is pressed.
  if (mousePressed){
    image(mustache, mouseX -50, mouseY);
  }
